//
//  swiftTableThreeViewController.swift
//  SwiftDemo
//
...
class swiftTableThreeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate  {
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        if searchText == "" {
            ...
            //清除多余字符 trimmingCharacters(in set: CharacterSet)
            //返回一个新的字符串，该字符串是通过从给定字符集中包含的String字符的两端删除而得到的。
