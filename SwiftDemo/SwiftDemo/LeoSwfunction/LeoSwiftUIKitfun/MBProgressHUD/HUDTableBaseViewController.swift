//
//  HUDTableBaseViewController.swift
//  SwiftDemo
//
...
@objc class HUDTableBaseViewController: UIViewController {
    ...
    lazy var tableView : UITableView = {
        ...
        tableView.register(HomeViewCell.self, forCellReuseIdentifier: HUDTableBaseViewController.BaseViewControllerCellIdentifier)
        return tableView
    }()
...
extension HUDTableBaseViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: HUDTableBaseViewController.BaseViewControllerCellIdentifier, for: indexPath) as! HomeViewCell
